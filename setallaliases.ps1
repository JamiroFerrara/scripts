...
Set-Alias -Name ctrans -Value 'C:\Scripts\CommitTransactionScript.ps1'
Set-Alias -Name etrans -Value 'C:\Scripts\EditTransactionScript.ps1'
...
Set-Alias -Name pullall -Value 'C:\scripts\PullAll.ps1'
Set-Alias -Name pall -Value 'C:\scripts\PullAll.ps1'
