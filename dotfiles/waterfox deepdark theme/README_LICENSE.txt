...
.: "DEEPDARK | RUBY EDITION" THEME LICENSE :.
...
In cases when Textual Source Code is copied from the Waterfox default theme,
...
.: IMAGES COPIED FROM THE DEFAULT WATERFOX THEME

Images copied from the default Waterfox theme are not restricted by this license.
Use of these images may be subject to license terms. For more information, please visit Waterfox website: www.waterfox.net
